...
export function createFA6IconSet(glyphMap, metadata, fonts, pro = false) {
    ...
    const sharpLightIcons = createFontAwesomeStyle('Sharp_Light', '300', `${fontFamily}Sharp`);
    const sharpIcons = createFontAwesomeStyle('Sharp_Regular', '400', `${fontFamily}Sharp`);
    const sharpSolidIcons = createFontAwesomeStyle('Sharp_Solid', '900', `${fontFamily}Sharp`);
    const duotoneIcons = createFontAwesomeStyle('Duotone', '900', `${fontFamily}Duotone`);
